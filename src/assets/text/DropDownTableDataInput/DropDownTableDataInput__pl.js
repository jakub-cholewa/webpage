const data = [
    ...
    },
    {
        ...
        answer: "Tak:) tak jak w tym przykłądzie, możliwe kolory : " +
            "navbar-transparent," +
            "bg-danger," +
            "bg-warning," +
            "bg-success," +
    ...
    {
        question: "Można ręcznie??",
        answer: "Pewnie : <DropDownTable\n" +
            "            color=\"rose\"\n" +
            "            a={item.question}\n" +
            "            b={item.answer}\n" +
            "        />, ale po co??"
    ...
    },
    {
        ...
        answer: "Teraz należało zachować więcej czujności, rozlew ów bowiem tworzył zarazem wodopój,\n" +
            "do którego wszelki zwierz okoliczny musiał koniecznie przychoǳić, gdyż gǳie inǳiej\n" +
